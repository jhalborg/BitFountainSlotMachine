...
class Factory {
    ...
    // En class function gør, at man ikke behøver at instantiere klassen for at kalde funktionen
    // Altså kan man bare kalde Factory.createSlots() frem fro at lave en factory, og så kalde metoden
    class func createSlots () -> [[Slot]] {
        
        let kNumberOfSlots = 3
        let kNumberOfContainers = 3
        // An array of arrays, i.e.
        // slots = [[slot1, slot2, slot3], [slot4, slot5, slot6], [slot 7, slot8, slot9]]
        // mySlotArray = slot [1]
        // slot = mySlotArray[0]
        var slots: [[Slot]] = []
