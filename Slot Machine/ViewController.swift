...
//  Slot Machine
//
//  Created by Jesper Madsen on 23/05/15.
...
class ViewController: UIViewController {
    ...
    // Divisions
    let kSixth:CGFloat = 1.0/6.0; // bruger kommatal for float
    ...
    func setupFourthContainer (containerView: UIView) {
        ...
        self.resetButton.setTitle("Reset", forState: UIControlState.Normal) // state er om der er trykket paa, highlighted, normal el. lign.
    ...
    func hardReset() {
        removeSlotImageViews()
        slots.removeAll(keepCapacity: true) // Reserves the memory allocated for the array for future use. Common when repopulating arrays with same information size
